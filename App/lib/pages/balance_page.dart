                  ...
                  Obx(
                    () => ElevatedButton.icon(
                      onPressed: ble.weightStable.value
                          ? () async {
                              // 🔒 VERIFICATION RGPD AVANT ENREGISTREMENT IOT
                              final consent = Get.find<ConsentService>();
                              if (!consent.hasConsentedHealthData.value) {
                                Get.snackbar(
                                  'Action bloquée', 
                                  'Vous avez refusé le traitement des données de santé. Modifiez vos choix dans le Profil.',
                              ...
                              try {
                                ...
                                if (userId != null) {
                                  await Get.find<AuthService>().addWeight(
                                    userId,
                                    ble.weight.value,
                                    source: 'balance_iot', // 🔒 On précise que la source est l'IoT
                                  );
                                  Get.snackbar(
                                    'Succès', 
                                ...
                                debugPrint('BALANCE WEIGHT ERROR: $e');
                                Get.snackbar(
                                  'Erreur', 
                                  'Impossible d\'enregistrer le poids.',
                                  snackPosition: SnackPosition.BOTTOM,
                                );
                              }
                            }
